...
class PrivacyPolicy extends React.Component {
  render() {
    ...
    return (
      <div>
        <p>Effective date: June 01, 2018</p>
        <p>
          Tlon Corporation ("us", "we", or "our") operates the website and the
          Urbit mobile application (the "Service").
        </p>
        <p>
        ...
        <p>Service</p>
        <p>
          Service means the website and the Urbit mobile application operated by
          Tlon Corporation
        </p>
        <p>Personal Data</p>
        <p>
        ...
        <p>Use of Data</p>
        <p>Tlon Corporation uses the collected data for various purposes:</p>
        ...
        <p>
          If you are from the European Economic Area (EEA), Tlon Corporation
        ...
        <p>Tlon Corporation may process your Personal Data because:</p>
        ...
        <p>
          Tlon Corporation will also retain Usage Data for internal analysis
        ...
        <p>
          Tlon Corporation will take all steps reasonably necessary to ensure
        ...
        <p>
          Tlon Corporation may disclose your Personal Data in the good faith
          belief that such action is necessary to:
        </p>
        <p>To comply with a legal obligation</p>
        <p>To protect and defend the rights or property of Tlon Corporation</p>
        <p>
        ...
        <p>
          ...
          certain data protection rights. Tlon Corporation aims to take
        ...
        <p>
          ...
          your consent at any time where Tlon Corporation relied on your consent
        ...
        <p>By email: support@urbit.org</p>
