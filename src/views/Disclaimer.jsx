    ...
    <View>
      <Grid gap={2} className="mt8 mb10">
        <Grid.Item full>
          <Text
            as="h3"
            style={{ ...textProps, fontSize: '16px', fontWeight: 'bold' }}>
            Disclaimer
          </Text>
        </Grid.Item>
        <Grid.Item full>
          ...
          <Text as="p" style={textProps}>
            <strong>You own and control your assets. We do not.</strong> If you
            send your assets to another address, we cannot get them back for
            you.
          </Text>

          <Text as="p" style={textProps}>
            Please understand that nobody can:
          </Text>

          <Text as={'ol'} style={{ paddingLeft: '1em' }}>
            <Text as="li" style={textProps}>
              Access your assets for you;
            </Text>
            <Text as="li" style={textProps}>
            ...
            <Text as="li" style={textProps}>
              Hold, back-up, or access your keys
            </Text>
          </Text>

          <Text as="p" style={{ ...textProps, fontWeight: 'bold' }}>
            You are responsible for keeping your information safe. This
            includes:
          </Text>

          <Text as={'ol'} style={{ paddingLeft: '1em' }}>
            <Text as="li" style={textProps}>
              Private Keys/Mnemonic Phrases and passwords;
            </Text>
            <Text as="li" style={textProps}>
              JSON files;{' '}
            </Text>
            ...
            <Text as="li" style={textProps}>
              Downloading this software from a reliable site, and ensuring it
