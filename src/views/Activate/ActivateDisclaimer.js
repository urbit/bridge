  ...
  return (
    <View>
      <Grid gap={2} className="mt8 mb10">
        ...
        <Grid.Item full>
          <Text className={cn(kTextStyle, 'block mb4')}>
          ...
          <B className={kTextStyle}>Please understand that nobody can:</B>
          <Text className={cn(kTextStyle, 'block mb4')}>
          ...
          <B className={kTextStyle}>To be clear</B>
          <Text className={cn(kTextStyle, 'block')}>
